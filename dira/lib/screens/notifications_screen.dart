      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => NotificationService.clearAllRead(clinicId),
          ),
        ],
      ),
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                background: Container(
                  ...
                  decoration: BoxDecoration(color: scheme.error, borderRadius: BorderRadius.circular(12)),
                  child: const Icon(Icons.delete_outline, color: Colors.white),
                ),
                onDismissed: (_) => NotificationService.deleteNotification(clinicId, doc.id),
                child: Container(
                  margin: const EdgeInsets.only(bottom: 8),
                  decoration: BoxDecoration(
                    color: isRead ? scheme.surfaceContainerLowest : scheme.primaryContainer.withOpacity(0.08),
